...
class CronSafeWebhookTests(TestCase):
    ...
    @patch('apps.calendars.services.google_calendar_client.GoogleCalendarClient')
    def test_force_recreate_replaces_valid_webhooks(self, mock_client_class):
        ...
        mock_service.channels.return_value.stop.return_value.execute.return_value = {}
        ...
        # Should have called cleanup and creation
        mock_service.channels.return_value.stop.assert_called_once()
