...
class CalendarAccountAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Sync Status", {"fields": ("get_last_sync", "get_sync_summary")}),
        (
            "Timestamps",
    ...
    def get_last_sync(self, obj):
        ...
        last_sync = (
            SyncLog.objects.filter(calendar_account=obj).order_by("-started_at").first()
        )
        if last_sync:
...
class EventAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "Relationships",
            {"fields": ("source_event", "source_event_link"), "classes": ("collapse",)},
        ),
        (
            "Timestamps",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
...
class SyncLogAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Statistics", {"fields": ("events_processed", "stats_display")}),
    ...
    def stats_display(self, obj):
        return format_html(
            ...
            obj.events_updated,
            obj.events_deleted,
            obj.busy_blocks_created,
            obj.busy_blocks_updated,
            obj.busy_blocks_deleted,
            obj.api_calls_made,
        )
